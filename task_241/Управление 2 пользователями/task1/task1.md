...
## Суперпользователь root обладает практически неограниченными правами в системе, но может столкнуться с некоторыми ограничениями, обусловленными:

## Механизмами защиты системы от случайных или неправильных действий (например, нельзя отформатировать корневую файловую систему, если она смонтирована).
## Политиками безопасности, действующими на уровне сети и межсетевых экранов (фаерволов).
